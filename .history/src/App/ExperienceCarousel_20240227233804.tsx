    ...
    return (
        <div className='expcar-background'>
            ...
            <div className='expcar-stack-item'>
                ...
                <ul>
                    <li>
                        Developed iOS application using <b>Swift</b> and <b>Firebase</b> to assist researchers with data collection with wearable IMU sensors
                    </li>
                    <li>
                    ...
                    <li>
                        Assisted development of a cross-platform mobile app with <b>React Native</b> guiding users to safer routes
                    </li>
                    <li>
            ...
            <div className='expcar-stack-item'>
                ...
                <ul>
                    <li>
                       Maintained and upgraded company website with HTML, CSS, and <b>JavaScript</b> and increased search engine visibility
                    </li>
