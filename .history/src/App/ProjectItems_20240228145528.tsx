...
const projectItems = {
    ...
    dpm_safeconnect: {
        ...
        description: "iOS app to calculate and record fatigue levels using heart rate + web dashboard to monitor fatigue levels, aimed to improve construction worker safety.",
        thumbnail: in_progress_thumbnail,
