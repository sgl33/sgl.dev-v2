                    ...
                    <div className='amcar-container'>
                        <div className='amcar-content'>
                            <ul>
                                ...
                                <li>I have interests in anthromorphic animals and I am a fursuiter. I'm not active in the community, but I enjoy hanging out with friends and going to conventions.</li>
                            </ul>
                        </div>
                    </div>
                    <div className='amcar-container'>
