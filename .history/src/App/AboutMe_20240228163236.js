                    ...
                    <div className='amcar-container'>
                        <div className='amcar-content'>
                            <ul>
                                ...
                                <li>I like K-indie, Pop/Alt-Pop, Rock, etc. and my favorite music artist is <a href='https://open.spotify.com/artist/4I13kBfOo5vI4LT8oNE0Fy' target='_blank'>Sagong</a>.</li>
                            </ul>
                        </div>
                    </div>
                    {/* Links */}
