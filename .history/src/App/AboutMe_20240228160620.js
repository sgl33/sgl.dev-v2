                    ...
                    <div className='amcar-container'>
                        <div className='amcar-content'>
                            <ul>
                                ...
                                <li>I love visiting theme parks and riding roller coasters. I am a season pass holder at Cedar Point.</li>
                                <li>I like playing Cities: Skylines and single-player or mass-multiplayer shooter games</li>
                                <li>Fursuiter</li>
                            </ul>
                        </div>
                    </div>
