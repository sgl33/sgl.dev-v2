...
const projectItems = {
    ...
    dpm_safeconnect: {
        ...
        description: "iOS app to calculate and record fatigue levels using heart rate + web dashboard to monitor fatigue levels + server to handle remote notifications, aimed to improve construction worker safety.",
        thumbnail: in_progress_thumbnail,
        project_types: ["Work Project", "Multiple Apps"],
        finished_date: "In Progress",
        platform_icons: [apple_icon, web_icon],
        tool_icons: [swift_icon, react_icon, js_icon, node_icon],
        platform_tools_text: "iOS, Web | Swift, React, JavaScript, Node.js",
        links: [
            {
                name: "Research",
                url: "https://dpm.engin.umich.edu/research/"
