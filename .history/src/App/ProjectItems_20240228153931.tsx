...
const projectItems = {
    ...
    custom_dashboard_v2: {
        ...
        description: "Web dashboard that shows calendar events, weather, current playing music (Spotify), travel times, and more.",
    ...
    kams_hub: {
        name: "KAMS Hub",
        description: "Student learning management portal for KAMS students, aimed to improve administrative efficiency.",
        thumbnail: kams_hub_thumbnail,
        project_types: ["Personal Project", "Web App"],
        finished_date: "May 2022",
        platform_icons: [web_icon],
        ...
        links: [
            {
                name: "Keynote",
                url: "https://docs.google.com/presentation/d/12auJBLl3WyBV4CmqO05tV9UaJzbjVCTjx-boZ9QhO-w/edit#slide=id.p"
            }
        ]
    },
    // Vex Robot
    ...
    classchat: {
        name: "ClassChat",
        description: "Realtime online chat service for socialization during COVID school closures. (Hackathon winner)",
        thumbnail: classchat_thumbnail,
        project_types: ["Hackathon Project", "Web App"],
