...
const projectItems = {
    ...
    classchat: {
        name: "ClassChat",
        description: "Realtime online chat service for school. Hackathon winner.",
        thumbnail: classchat_thumbnail,
        project_types: ["Group Project", "Hackathon", "Web App"],
        finished_date: "Nov 2021",
        platform_icons: [web_icon],
        ...
        links: [
            {
                name: "Demo",
                url: "https://classchat-2021.herokuapp.com/"
            },
            {
                name: "Devpost",
                url: "https://devpost.com/software/classchat"
            }
        ]
    },
    // Hexagon Defense
