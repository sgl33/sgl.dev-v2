    ...
    return (
        <div className='expcar-background'>
            ...
            <div className='expcar-stack-item'>
                ...
                <ul>
                    <li>Developed iOS application using <b>Swift</b> and <b>Firebase</b> to assist researchers with data collection from 64 participants for walking safety AI model training with wearable IMU sensors</li>
                </ul>
