        ...
        <div className='expcar-background'>
            ...
            <div className='expcar-stack-item'>
                ...
                <ul>
                    ...
                    <li>
                        Wrote <b>Python</b> web scrapers and data processors to collect a dataset of ~120,000 images and assisted with training computer vision model; placed 1st in national ASCE datathon
                    </li>
                </ul>
