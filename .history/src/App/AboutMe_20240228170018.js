            ...
            <div id='about-me-carousel'>
                <Slider {...sliderSettings} ref={slider => { sliderRef = slider; }}>
                    ...
                    <div className='amcar-container'>
                        <div className='amcar-content'>
                            <ul>
                                <li>I've lived in 4 different states in th: Michigan, Texas, Kansas, and Pennsylvania! I've lived in diverse climates ranging from -35&deg;F to 110&deg;F.</li>
                                ...
                                <li>I don't drink coffee or energy drinks because I don't like the taste.</li>
                            </ul>
                        </div>
                    </div>
                    {/* Links */}
