            ...
            <div id='about-me-carousel'>
                <Slider {...sliderSettings} ref={slider => { sliderRef = slider; }}>
                    ...
                    <div className='amcar-container'>
                        <div className='amcar-content'>
                            <ul>
                                ...
                                <li>I love visiting <b>theme parks</b> and riding roller coasters. My favorite rides are Velocicoaster at Universal's Islands of Adventure (Orlando, FL) and Maverick at Cedar Point (Sandusky, OH).</li>
                    ...
                    <div className='amcar-container'>
                        <div className='amcar-content'>
                            <ul>
                                <li>I've lived in 4 different states in the US: Michigan, Texas, Kansas, and Pennsylvania! I've lived in diverse climates ranging from -35&deg;F to 110&deg;F.</li>
                                ...
                                <li>My name means "win 9 times" in Korean.</li>
                                <li>I don't drink coffee, energy drinks, or alcohol.</li>
                            </ul>
                        </div>
                    </div>
                    {/* Links */}
